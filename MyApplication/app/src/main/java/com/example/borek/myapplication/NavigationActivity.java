...
public class NavigationActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.nav_home:
                Intent h = new Intent(NavigationActivity.this, MainActivity.class);
                startActivity(h);
                break;
            case R.id.nav_weather:
                Intent w = new Intent(NavigationActivity.this, WeatherActivity1.class);
                startActivity(w);
                break;
            case R.id.nav_map:
                Intent m = new Intent(NavigationActivity.this, RunningMapsActivity.class);
                startActivity(m);
                break;
